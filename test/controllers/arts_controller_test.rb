...
class ArtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create art" do
    assert_difference('Art.count') do
      post arts_url, params: { art: { author: @art.author, photo: @art.photo, title: @art.title, year: @art.year } }
    end
  ...
  test "should update art" do
    patch art_url(@art), params: { art: { author: @art.author, photo: @art.photo, title: @art.title, year: @art.year } }
